...
CREATE TABLE `seat_availability` (
  ...
  PRIMARY KEY (`Train_code`,`Class_code`),
  KEY `idx_seats` (`Train_code`,`Class_code`,`Number_of_seats`),
  CONSTRAINT `seat_availability_ibfk_1` FOREIGN KEY (`Train_code`) REFERENCES `train` (`Train_code`)
...
INSERT INTO `seat_availability` VALUES ('T001','EC',100),('T001','SC',120),('T002','AC',80),('T003','SC',150);
