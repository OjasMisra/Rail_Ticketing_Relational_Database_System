...
CREATE TABLE `station` (
  ...
  KEY `station_ibfk_1` (`region_id`),
  CONSTRAINT `station_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `region` (`region_id`)
...
INSERT INTO `station` VALUES (1,'ST01','Station A',1),(2,'ST02','Station B',1),(3,'ST03','Station C',2),(4,'ST04','Station D',2),(5,'ST05','Station E',3);
