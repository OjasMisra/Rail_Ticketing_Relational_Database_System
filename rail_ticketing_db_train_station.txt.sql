...
CREATE TABLE `train_station` (
  ...
  CONSTRAINT `train_station_ibfk_1` FOREIGN KEY (`Train_code`) REFERENCES `train` (`Train_code`),
...
INSERT INTO `train_station` VALUES ('T001',1),('T001',2),('T002',2),('T002',3),('T003',3),('T003',4);
